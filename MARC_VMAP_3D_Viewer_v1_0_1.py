# -*- coding: utf-8 -*-
"""
VMAP 3D VIEWER v1.0.47 - Vibracoustic EU FEA Department
...
<span>European FEA Department - v1.0.47</span>
</div>
...
class App:
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("VMAP 3D Viewer v1.0.47")
    ...
    def setup(self):
        ...
        tk.Label(tf, text="European FEA Department - v1.0.47", font=('Arial', 9, 'italic'), fg='#ffccaa', bg='#d4542a').pack()
